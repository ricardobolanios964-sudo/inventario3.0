...
const CONFIG = {
  ...
  appsScriptURL: "https://script.google.com/macros/s/AKfycbz-eL1APkw1GFhnrJ8Awuwpn1kfN9RGYopHbv4EASwZKpd0JoTu9tN1smeB6etIU9O9Sw/exec",
...
function selectProduct(product) {
  ...
  document.getElementById("pvmp").value = ""
  document.getElementById("pvmp2").value = ""
...
function handleSubmit(e) {
  ...
  const pvmpInput = document.getElementById("pvmp")
  const pvmp2Input = document.getElementById("pvmp2")
  
  if (window.formatCurrency) {
    window.formatCurrency(pvmpInput)
    window.formatCurrency(pvmp2Input)
  }

  const pvmp = pvmpInput.value.trim()
  const pvmp2 = pvmp2Input.value.trim()
...
async function submitCount(data) {
  ...
  // ID_REGISTRO, FECHA, HORA INCIO, HORA FIN, CODIGO, NOMBRE, CANTIDAD_FISICA, PVMP, PVMP2, OBSERVACIONES, ESTATUS
  const countData = {
